    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      ...
      >
        <div className="sticky top-0 bg-white rounded-t-3xl border-b border-gray-100 px-4 sm:px-6 py-4 flex justify-between items-center">
          <h3 className="text-xl sm:text-2xl font-bold text-gray-800 truncate">{title}</h3>
          <button
...
const PrintingServiceHomepage = () => {
  ...
  const [showShopStatusNotification, setShowShopStatusNotification] = useState(false);
  ...
  const handleFileProcessing = async (file) => {
    ...
    if (file && file.type === 'application/pdf') {
      ...
      try {
        ...
        console.log(`Using fallback estimation: ${estimatedPageCount} pages (file size: ${fileSizeInKB.toFixed(2)}KB)`);
        ...
        if (selectedServiceDetails) {
          ...
          alert(`PDF loaded with estimated ${estimatedPageCount} pages. Actual page count will be verified during processing.`);
        }
      }
    } else {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <header className="relative z-20 bg-gradient-to-r from-blue-700 via-blue-800 to-indigo-900 shadow-2xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6 flex items-center justify-between">
          ...
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white">Our Services</h1>
  ...
  const HomePage = () => (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        ...
        <div className="text-white py-2 px-4 sm:px-6 max-w-7xl mx-auto flex justify-between items-center text-xs sm:text-sm font-semibold">
          <div className="flex items-center gap-3 sm:gap-6">
            <div className="flex items-center gap-2">
              ...
              <span className="hidden sm:inline">{user ? `Hi ${user.firstName}` : 'Kindly Login'}</span>
              <span className="sm:hidden">{user ? `Hi ${user.firstName}` : 'Login'}</span>
            </div>
            <div className="flex items-center gap-2">
              <span className={`w-2.5 h-2.5 ${isShopOpen ? 'bg-green-400' : 'bg-red-400'} rounded-full animate-pulse`}></span>
              <span className={`${isShopOpen ? 'bg-emerald-600' : 'bg-red-600'} px-2 sm:px-3 py-1 rounded-full text-xs tracking-wide`}>
        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
          <div className="flex items-center gap-3 sm:gap-4">
            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-blue-500 to-indigo-700 rounded-full flex items-center justify-center shadow-md cursor-pointer">
              <img src={nitaplogo} alt="NIT-AP Logo" className="w-8 h-8 sm:w-10 sm:h-10" />
            </div>
            <div
          ...
          <div className="lg:hidden flex items-center gap-2">
            ...
            {!user ? (
              ...
              <div className="bg-white/20 backdrop-blur-sm px-2 py-1 rounded-lg border border-white/30">
                <span className="text-white text-xs font-medium">{user.firstName}</span>
              </div>
            )}
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-16">
          ...
          <div className="bg-gradient-to-r from-red-500 via-red-600 to-red-700 text-white p-6 sm:p-8 rounded-3xl shadow-xl mb-12 sm:mb-16 border border-red-300">
            <div className="text-center">
              <div className="flex items-center justify-center gap-3 mb-4">
                ...
                <h3 className="text-2xl sm:text-3xl font-bold">Shop Currently Closed</h3>
              </div>
        ...
        {/* Service Selection */}
        <div className={`bg-white rounded-3xl shadow-xl p-6 sm:p-10 mb-16 sm:mb-24 border border-gray-100 ${!isShopOpen ? 'opacity-50 pointer-events-none' : ''}`}>
        ...
        {/* Settings Selection */}
        {selectedService && (
          <div className={`bg-white rounded-3xl shadow-xl p-6 sm:p-8 mb-12 sm:mb-16 border border-gray-100 ${!isShopOpen && !isAdmin ? 'opacity-50 pointer-events-none' : ''}`}>
            ...
            >
              <div className={`transition-all duration-300 ${isDragOver ? 'scale-110' : ''}`}>
                ...
                <h4 className="text-xl font-semibold text-gray-700 mb-2">
                  {isLoading ? 'Processing PDF...' : 'Drag and drop your PDF here'}
                </h4>
                <p className="text-gray-500 mb-6">
                  {isLoading ? 'Please wait while we count the pages' : 'or click to browse files'}
                </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="col-span-1 sm:col-span-2 lg:col-span-1">
              ...
              <p className="text-gray-400 mb-4 leading-relaxed">
                Your trusted campus printing partner providing fast, reliable, and affordable printing services.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                <li className="hover:text-white transition-colors cursor-pointer">B&W Printing</li>
                <li className="hover:text-white transition-colors cursor-pointer">Color Printing</li>
                ...
                <li className="hover:text-white transition-colors cursor-pointer">Document Printing</li>
                <li className="hover:text-white transition-colors cursor-pointer">Fast Delivery</li>
              </ul>
            </div>
            <div>
    ...
    >
      {cartItems.length === 0 ? (
        ...
        <div className="space-y-4 sm:space-y-6">
          {cartItems.map((item) => (
            <div key={item.id} className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl p-4 sm:p-6 border border-gray-100">
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                  <h4 className="font-semibold text-gray-800 mb-1 text-lg">
                    {item.service}
                  </h4>
                  <p className="text-sm text-gray-600 truncate" title={item.fileName}>
                    📄 {item.fileName}
                  </p>
      ...
      <div className="bg-white rounded-xl border overflow-hidden">
        {myOrders.length === 0 ? (
          ...
          <div className="space-y-4 p-4 sm:p-6">
            {myOrders.map((order) => (
              <div key={order.id} className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl p-4 sm:p-6 border border-gray-100">
                <div className="flex flex-col lg:flex-row lg:items-center gap-4">
                  {/* Order Info */}
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <h4 className="font-bold text-lg text-gray-900">{order.service}</h4>
                    ...
                    <p className="text-sm text-gray-600 mb-3 flex items-center gap-2">
                      📄 <span className="truncate">{order.fileName.length > 30 ? order.fileName.substring(0, 30) + '...' : order.fileName}</span>
                    </p>

                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
                      <div className="flex items-center gap-1">
                        <span className="w-2 h-2 bg-blue-400 rounded-full"></span>
                        <span className="text-gray-600">Pages: <strong>{order.pages}</strong></span>
                      </div>
                      <div className="flex items-center gap-1">
                        <span className="w-2 h-2 bg-green-400 rounded-full"></span>
                        <span className="text-gray-600">Copies: <strong>{order.copies}</strong></span>
                      </div>
                      <div className="flex items-center gap-1">
                        <span className="w-2 h-2 bg-purple-400 rounded-full"></span>
                        <span className="text-gray-600">{order.colorMode}</span>
                      </div>
                      <div className="flex items-center gap-1">
                        <span className="w-2 h-2 bg-orange-400 rounded-full"></span>
                        <span className="text-gray-600">{order.paperSize}</span>
                      </div>
                    </div>
                  ...
                  <div className="flex flex-col sm:flex-row lg:flex-col items-start sm:items-center lg:items-end gap-3">
                    <div className="text-right">
                      ...
                      {order.estimatedTime && (
                        <p className="text-xs text-gray-500">Est: {order.estimatedTime}</p>
                      )}
                    </div>
                ...
                {order.notes && (
                  <div className="mt-4 p-3 bg-yellow-50 rounded-xl border border-yellow-200">
                    <p className="font-medium text-yellow-800 text-sm">📝 Note:</p>
